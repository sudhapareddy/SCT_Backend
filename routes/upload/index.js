...
const clrCowTable = require("./clrCowTable");
const clrBufTable = require("./clrBufTable");
...
router.use("/clr-cow-table", verifyToken, authorizeRoles('admin', 'dairy', 'device'), clrCowTable);
router.use("/clr-buf-table", verifyToken, authorizeRoles('admin', 'dairy', 'device'), clrBufTable);
